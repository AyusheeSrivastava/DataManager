...
<h3>Go on!!!</h3>
<h4>Fill up the form and submit it to become a Member of the Community.</h4>
<form id="signup_form">
...
<table>
	...
	<tr>
		...
		<td><label id="userid_unique" class="userid_unique" style="cursor:pointer;">Check for Availability.</label>
		</td>
