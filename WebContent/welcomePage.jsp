...
<h1 style="color:white;font-family:fantasy;">
	Welcome User to a Completely New Data Managing Experience.
</h1>
</center>
</div>
<div id="sub_header">
...
<h3 style="font-family:serif;"><i>
	The tool is designed in a way so as to make you feel completely free to save your data in a Key-Value Pair.
	Kindly proceed and make your self relieved from memorizing Data.
	</i>
</h3>
</center>
</div>
...
<center>
<h5>
	New User!!! then <label id="register_form" data-toggle="modal" data-target="#myModal-1" style="color:blue;font-style:italic;cursor:pointer;">Sign-up</label>
</h5>
</center>
</td>
<td><label>&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
...
<center>
<h5>
	Already a Member!!! then <label id="login_form" data-toggle="modal" data-target="#myModal-1" style="color:blue;font-style:italic;cursor:pointer;">Login</label>
</h5>
</center>
</td>
</tr>
